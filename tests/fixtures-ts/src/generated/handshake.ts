 ...
 */
export const CYCLONE_SCHEMA_FINGERPRINT: bigint = 0x56B298A0BA39394Dn;

/** `DeviceState`, as declared - every annotated field, whatever codec it joined. */
export const DEVICE_STATE_FINGERPRINT: bigint = 0xD58389D19E8108CFn;
...
export const DEVICE_STATE_EDGE_FINGERPRINT: bigint = 0xBE8BFAB8409B6C81n;
...
export const DEVICE_STATE_UNITY_FINGERPRINT: bigint = 0x026BE19F15D14CC3n;

/** `EveryPrimitive`, as declared - every annotated field, whatever codec it joined. */
export const EVERY_PRIMITIVE_FINGERPRINT: bigint = 0x02F1E5F4076EBB87n;
...
export const EVERY_PRIMITIVE_EDGE_FINGERPRINT: bigint = 0xEF55232045A55262n;

/** `Player`, as declared - every annotated field, whatever codec it joined. */
export const PLAYER_FINGERPRINT: bigint = 0x013AFF75AC388095n;

/** `Player.edge` - the wire contract `PlayerEdgeCodec` encodes and decodes. */
export const PLAYER_EDGE_MESSAGE_ID: number = 0x432AB486;
export const PLAYER_EDGE_FINGERPRINT: bigint = 0xEE4B267575548A07n;
...
export const PLAYER_UNITY_FINGERPRINT: bigint = 0x293B91B31F6C0985n;

/** `PlayerInfo`, as declared - every annotated field, whatever codec it joined. */
export const PLAYER_INFO_FINGERPRINT: bigint = 0xD520365F3A499794n;
...
export const PLAYER_INFO_EDGE_FINGERPRINT: bigint = 0xA432F144FB89B1ECn;

/** `Team`, as declared - every annotated field, whatever codec it joined. */
export const TEAM_FINGERPRINT: bigint = 0x9EAF0DACA9A9B82Dn;

/** `Team.edge` - the wire contract `TeamEdgeCodec` encodes and decodes. */
export const TEAM_EDGE_MESSAGE_ID: number = 0x90AF7FE0;
export const TEAM_EDGE_FINGERPRINT: bigint = 0x3B370E0D3205FCDCn;

/** `Telemetry`, as declared - every annotated field, whatever codec it joined. */
export const TELEMETRY_FINGERPRINT: bigint = 0xCE20337FC994AB08n;
...
export const TELEMETRY_EDGE_FINGERPRINT: bigint = 0xF4D5573BB3116713n;
...
export const TELEMETRY_ORANGE_PI_FINGERPRINT: bigint = 0xC735BA3973767EFBn;
