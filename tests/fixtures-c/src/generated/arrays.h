...
typedef struct CycloneArray_PlayerInfo {
    struct PlayerInfo *items;
    size_t count;
} CycloneArray_PlayerInfo;

typedef struct CycloneArray_string {
    const char * *items;
    size_t count;
} CycloneArray_string;

static inline void CycloneArray_string_free(CycloneArray_string *array) {
